...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|questionStudentAddDTO|课堂练习作答新增DTO|body|true|QuestionStudentAddDTO|QuestionStudentAddDTO|
...
|&emsp;&emsp;answer|作答内容||false|AnswerPayload|AnswerPayload|
|&emsp;&emsp;&emsp;&emsp;content|||false|string||
|&emsp;&emsp;&emsp;&emsp;options|||false|array|string|
|&emsp;&emsp;&emsp;&emsp;blanks|||false|array|string|
|&emsp;&emsp;isCorrect|是否正确||false|boolean||
|&emsp;&emsp;score|得分||false|number(float)||
|&emsp;&emsp;submitTime|提交时间||false|string(date-time)||
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|questionStudentDTO|课堂练习作答更新DTO|body|true|QuestionStudentDTO|QuestionStudentDTO|
|&emsp;&emsp;id|作答记录ID||true|string(uuid)||
|&emsp;&emsp;classroomId|课堂记录ID||true|string(uuid)||
|&emsp;&emsp;studentId|学生ID||true|string(uuid)||
|&emsp;&emsp;questionId|题目ID||true|string(uuid)||
|&emsp;&emsp;answer|作答内容||false|AnswerPayload|AnswerPayload|
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|id|作答记录ID|path|true|string(uuid)||
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|ResultQuestionStudentVO|
|400|Bad Request|ResultMapStringString|
|403|Forbidden|ResultString|
...
|code|业务状态码 (200表示成功)|integer(int32)|integer(int32)|
|message|响应消息|string||
|data||QuestionStudentVO|QuestionStudentVO|
|&emsp;&emsp;id|作答记录ID|string(uuid)||
|&emsp;&emsp;classroomId|课堂记录ID|string(uuid)||
|&emsp;&emsp;studentId|学生ID|string(uuid)||
|&emsp;&emsp;questionId|题目ID|string(uuid)||
|&emsp;&emsp;answer|作答内容|AnswerPayload|AnswerPayload|
|&emsp;&emsp;&emsp;&emsp;content||string||
|&emsp;&emsp;&emsp;&emsp;options||array|string|
|&emsp;&emsp;&emsp;&emsp;blanks||array|string|
|&emsp;&emsp;isCorrect|是否正确|boolean||
|&emsp;&emsp;score|得分|number(float)||
...
| 状态码 | 说明 | schema |
| -------- | -------- | ----- | 
|200|OK|ResultListQuestionStudentVO|
|400|Bad Request|ResultMapStringString|
|403|Forbidden|ResultString|
...
|code|业务状态码 (200表示成功)|integer(int32)|integer(int32)|
|message|响应消息|string||
|data|响应数据体 (泛型)|array|QuestionStudentVO|
|&emsp;&emsp;id|作答记录ID|string(uuid)||
|&emsp;&emsp;classroomId|课堂记录ID|string(uuid)||
|&emsp;&emsp;studentId|学生ID|string(uuid)||
|&emsp;&emsp;questionId|题目ID|string(uuid)||
...
**接口地址**:`/api/student/practice/list`
...
|questionId|题目ID|query|false|string||
|startTime|起始时间|query|false|string||
|endTime|结束时间|query|false|string||
|pageNum|当前记录起始索引|query|false|string||
|pageSize|每页显示记录数|query|false|string||
...
**接口地址**:`/api/student/practice/summary/me`
...
## listByClassroomInternal


**接口地址**:`/api/student/practice/internal/classroom/{classroomId}`
...
**接口描述**:<p>根据课堂ID查询所有学生作答记录（内部接口）</p>
...
**接口地址**:`/api/student/student/internal`
...
**接口地址**:`/api/student/student/internal/{id}`
...
**接口地址**:`/api/student/student/internal/all`
...
**接口地址**:`/api/student/student/internal/batch`
...
**接口地址**:`/api/student/student/internal/list`
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|arg0|学生信息查询条件|query|true|StudentQueryDTO|StudentQueryDTO|
|&emsp;&emsp;startTime|起始时间||false|string(date-time)||
|&emsp;&emsp;endTime|结束时间||false|string(date-time)||
|&emsp;&emsp;pageNum|当前记录起始索引||false|integer(int32)||
|&emsp;&emsp;pageSize|每页显示记录数||false|integer(int32)||
|&emsp;&emsp;orderByColumn|排序列||false|string||
|&emsp;&emsp;isAsc|排序的方向,可用值:asc,desc||false|string||
|&emsp;&emsp;reasonable|分页参数合理化||false|boolean||
|&emsp;&emsp;studentCode|学号||false|string||
|&emsp;&emsp;realName|学生真实姓名||false|string||
|&emsp;&emsp;admissionYear|入学年份||false|integer(int32)||
|&emsp;&emsp;major|专业||false|string||
|&emsp;&emsp;academicStatus|学籍状态 (0=在读, 1=休学, 2=退学, 3=毕业)||false|integer(int32)||
...
**接口地址**:`/api/student/student/internal/user/{id}`
