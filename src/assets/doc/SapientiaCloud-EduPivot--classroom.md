...
|&emsp;&emsp;questionTitle|题目标题||false|string||
...
|&emsp;&emsp;status|状态 (0=待作答, 1=待批阅, 2=已批阅)||false|integer(int32)||
...
|&emsp;&emsp;status|状态 (0=待作答, 1=待批阅, 2=已批阅)|integer(int32)||
...
**接口地址**:`/api/classroom/classroom-practice/sync`
...
| 参数名称 | 参数说明 | 请求类型    | 是否必须 | 数据类型 | schema |
| -------- | -------- | ----- | -------- | -------- | ------ |
|classroomQuestionDTOs|课堂练习发布与更新DTO|body|true|array|ClassroomQuestionDTO|
|&emsp;&emsp;id|记录ID（更新时必填）||false|string(uuid)||
|&emsp;&emsp;classroomId|课堂记录ID||true|string(uuid)||
|&emsp;&emsp;questionId|题目ID||true|string(uuid)||
|&emsp;&emsp;questionTitle|题目标题||false|string||
...
## removeClassroomQuestionById


**接口地址**:`/api/classroom/classroom-question/{id}`
...
**接口地址**:`/api/classroom/classroom-question/add`
...
**接口地址**:`/api/classroom/classroom-question/classroom/{classroomId}`
...
**接口地址**:`/api/classroom/classroom-question/internal/status`
...
## listClassroomQuestion


**接口地址**:`/api/classroom/classroom-question/list`
...
**接口地址**:`/api/classroom/classroom-question/update`
