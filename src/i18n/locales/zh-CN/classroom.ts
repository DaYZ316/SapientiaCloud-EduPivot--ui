export default {
    ...
    fetchCourseRecordFailed: '获取课程记录失败，使用默认配置',
    noMeshObjectsFound: '未在桌椅模型中找到任何网格对象',
    fetchStudentsListFailed: '获取学生座位信息失败',
    editSeating: '编辑座位',
    noStudentIdentityContent: '当前账户未绑定学生信息，请先绑定学生身份',
    seatOccupied: '该座位已有同学入座，请选择其他空位',
